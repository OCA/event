...
odoo.define("website_event_sale_b2x_alt_price.tour_b2b", function(require) {
    "use strict";
    ...
    var steps = [
        ...
        },
        {
            ...
            extra_trigger:
                ".col-lg-8:has(h6:contains('Test Ticket')):has(.event_b2x_flex_centered:has(span:has(.oe_currency_value:contains(100.00))):has(.text-muted:has(span:has(.oe_currency_value:contains(122.00)))))",
        },
        {
        ...
        {
            trigger:
                ".row:has(.col-md-8:has(h5:contains('Test Ticket 1'))):has(.col-md-4:has(div:has(.event_b2x_flex_centered:has(span:has(.oe_currency_value:contains(100.00))):has(.text-muted:has(span:has(.oe_currency_value:contains(122.00)))))))",
        },
        {
            trigger:
