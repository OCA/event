...
registry
    ...
    .add("website_event_sale_b2x_alt_price_b2c_with_discount", {
        test: true,
        url: "/event",
        steps: () => [
            {
            ...
            {
                extra_trigger:
                    ".o_wevent_registration_single:has(span[data-oe-field='price_reduce_taxinc']:contains('109.80')):has(span.js_alt_price:contains('90.00'))",
