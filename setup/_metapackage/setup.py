...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo-addon-event_min_seat>=15.0dev,<15.1dev',
        ...
        'odoo-addon-event_stage_cancelled>=15.0dev,<15.1dev',
        ...
        'odoo-addon-website_event_track_stage_cancelled>=15.0dev,<15.1dev',
    ],
    classifiers=[
